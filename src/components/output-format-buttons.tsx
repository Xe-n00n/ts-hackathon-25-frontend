        ...
        <div className="flex items-center gap-4 mr-16">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger asChild>
                    <Button variant="darkRed" className={baloo2.className}>
                        Done
                    </Button>
                </DialogTrigger>
                ...
                <DialogContent className="sm:max-w-[425px] bg-white border border-dark-red rounded-2xl p-6">
                    <DialogHeader>
                        <DialogTitle className={`text-center text-3xl font-medium ${baloo2.className}`}>
                            Are you sure?
                        </DialogTitle>
                    </DialogHeader>
                    ...
                    <DialogFooter className="flex justify-between items-center">
                        ...
                        <Button variant="darkRed" onClick={handleDone}>
                            Yes
                        </Button>
                    </DialogFooter>
                </DialogContent>
