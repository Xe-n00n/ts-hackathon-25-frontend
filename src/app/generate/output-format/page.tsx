    ...
    return (
        <div className={`h-screen max-h-screen overflow-hidden container mx-auto pt-4 pb-2 flex flex-col ${baloo2.className}`}>
            ...
            <div className="w-4/5 mx-auto mb-2">
                <Stepper steps={5} activeStep={1} colors={["var(--green)", "var(--orange)", "var(--yellow)", "var(--purple)", "var(--dark-red)"]} />
            </div>
            <div className="w-4/5 mx-auto flex-1 space-y-2 mb-2">
                ...
                <CardSelector color="dark-red" options={cardOptions} className="grid grid-cols-2 gap-12 w-4/5 mx-auto" />
            </div>
